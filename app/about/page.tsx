...
export default function AboutPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start border-b border-black/10 dark:border-white/[0.08] pb-14">
        <div className="lg:col-span-8 space-y-5">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-neutral-900 dark:text-white leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-[#d94e34] to-indigo-500 dark:from-indigo-400 dark:via-cyan-300 dark:to-indigo-200">
              Commercial Strategy.
            </span>
          </h1>
          ...
          <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed max-w-2xl border-l-2 border-indigo-500 pl-4">
            My engineering foundation is grounded in Digital Signal Processing and statistical rigor at Manipal Institute of Technology (MIT), battle-tested delivering <span className="text-emerald-700 dark:text-emerald-400 font-mono font-semibold">+$12M</span> in premium adjustments with compound GLMs at EXL Service, and elevated through graduate business education focusing on tech strategy and unit economics.
          </p>
        </div>
        ...
        <div className="lg:col-span-4 space-y-4">
          <div className="artifact-card rounded-2xl p-6 space-y-4">
            <div className="flex items-center justify-between font-mono text-xs text-neutral-500 dark:text-neutral-400 border-b border-black/10 dark:border-white/[0.06] pb-3">
            ...
            <div>
              ...
              <div className="text-xs font-mono text-cyan-700 dark:text-cyan-300 mt-0.5">
            ...
            <p className="text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed pt-2 border-t border-black/10 dark:border-white/[0.06]">
      ...
      <section className="space-y-6 pt-4 border-t border-black/10 dark:border-white/[0.08]">
        <div className="space-y-1">
          <div className="text-xs font-mono uppercase tracking-widest text-cyan-700 dark:text-cyan-400">
          ...
          {skillMatrix.map((matrix) => {
            ...
            return (
              <div key={matrix.category} className="artifact-card rounded-2xl p-6 space-y-4">
                <div className="flex items-center gap-2.5 font-mono text-xs text-neutral-800 dark:text-neutral-200 border-b border-black/10 dark:border-white/[0.06] pb-3">
      ...
      <section className="artifact-card rounded-2xl p-8 sm:p-10 space-y-4 border-l-4 border-indigo-500">
        <div className="text-xs font-mono uppercase tracking-widest text-indigo-600 dark:text-indigo-400 font-semibold">
          CORE PHILOSOPHY // 01
        </div>
        <h3 className="text-2xl sm:text-3xl font-semibold text-neutral-900 dark:text-white tracking-tight">
          Form Follows Function.
        </h3>
        <p className="text-sm sm:text-base text-neutral-700 dark:text-neutral-300 max-w-3xl leading-relaxed">
