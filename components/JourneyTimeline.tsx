  ...
  return (
    <section className="space-y-8">
      <div className="space-y-2">
        <div className="inline-flex items-center gap-1.5 text-xs font-mono uppercase tracking-widest text-indigo-400">
            ...
            >
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between font-mono text-xs">
                  ...
                  <span className="text-neutral-500 text-[11px]">{stage.period}</span>
                </div>
                ...
                <ul className="space-y-1.5 text-xs text-neutral-400 pt-2 border-t border-white/[0.06]">
              ...
              <div className="pt-2 flex items-center justify-between text-[11px] font-mono text-neutral-500 border-t border-white/[0.04]">
